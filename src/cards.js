...
<div class="card-body">
    <ul class="list-group">
        ...
        <li class="list-group-item">Email: <a href="mailto:${newEmployee.email}">${newEmployee.email}</a></li>
        <li class="list-group-item">Room #: (if applicable): ${newEmployee.room}</li>
        <li class="list-group-item">School: (if applicable): ${newEmployee.school}</li>
        <li class="list-group-item">Github Username: (if applicable): ${newEmployee.github}</li>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 jumbotron mb-3 team-heading bg-primary">
                    <h1 class="text-center text-white">Company HEROES</h1>
                </div>
            </div>
        </div>
        <div class="container">
